...
nsXBLProtoImpl::CompilePrototypeMembers(nsXBLPrototypeBinding* aBinding)
{
  ...
  mPrecompiledMemberHolder = JS_NewObjectWithGivenProto(cx, nullptr, nullptr, compilationGlobal);
  if (!mPrecompiledMemberHolder)
                     ...
                     nsXBLPrototypeBinding* aBinding)
{
  ...
  mPrecompiledMemberHolder = JS_NewObjectWithGivenProto(cx, nullptr, nullptr, global);
  if (!mPrecompiledMemberHolder)
    return NS_ERROR_OUT_OF_MEMORY;
