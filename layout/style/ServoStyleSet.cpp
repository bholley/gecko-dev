...
{
  MOZ_ASSERT(aContent->IsDirtyForServo() || aContent->HasDirtyDescendantsForServo());

  // XXX: File bug about managing the bits on the servo side.
  ServoRestyleManager::AssertSubtreeIsExplicitlyDirty(aContent,
                                                      /* aIncludeRoot = */ false);
